          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                id="role"
                name="role"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-studio-x focus:border-studio-x sm:text-sm"
                value={role}
