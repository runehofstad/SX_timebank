          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div className="mb-4">
              ...
              <input
                ...
                disabled
                className="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-studio-x focus:border-studio-x focus:z-10 sm:text-sm bg-gray-100"
              />
            </div>
